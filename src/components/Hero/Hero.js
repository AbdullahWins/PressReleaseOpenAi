...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-start bg-heroBg bg-no-repeat bg-top text-center md:h-[1000px] md:pt-10">
      <TopNav></TopNav>
      <div className="flex flex-col items-center justify-center py-8 md:py-0 md:pt-[189px] text-whiteHigh">
        <div className="text-5xl md:text-8xl pb-8 md:pb-16 font-black">
          <p>The AI Press</p> <p>Release Writting Tool</p>
        </div>
        <p className="w-3/5 text-xl md:text-2xl">
