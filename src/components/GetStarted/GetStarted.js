...
const GetStarted = () => {
  return (
    <section className="flex items-center justify-center mb-8 md:-mb-28 z-10">
      <div className="flex items-center justify-between text-whiteHigh  w-10/12 bg-gradient-to-r from-getStartedGradientStart to-getStartedGradientEnd rounded-2xl">
