...
const GetStarted = () => {
  return (
    <section className="flex items-center justify-center mb-[-200px] z-10">
      <div className="flex items-center justify-between text-whiteHigh md:h-[420px] max-w-6xl bg-gradient-to-r from-getStartedGradientStart to-getStartedGradientEnd rounded-2xl">
