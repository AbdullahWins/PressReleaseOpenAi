        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-4 py-10 px-4">
          <div className="bg-whiteHigh rounded-2xl p-6 min-h-80">
            ...
            <p className="text-start md:text-2xl text-blackLow">
              ...
              experience and resolving any issues you may encounter. Whether you
              need assistance with registering for an account, using the webapp,
              or modifying your account settings, we are happy to assist you.
              <br />
              <br />
