        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-4 py-10 px-4">
          <div className="bg-whiteHigh rounded-2xl p-6 min-h-80">
            ...
            <p className="text-base md:text-2xl text-aboutDetailsColor pt-12">
              ...
              helpful information. Its advanced language processing capabilities
              make it convenient for both personal and business use.
            </p>
          </div>
          <div className="bg-whiteHigh rounded-2xl p-6 min-h-80">
            ...
            <p className="text-base md:text-2xl text-aboutDetailsColor pt-12">
              Netro Creative's Press Writer AI is a News Generator app that uses
              Chat GPT API, helping users to accomplish their tasks and obtain
              helpful information via natural language conversations, thanks to
              its advanced language processing features. You're responsible for
              its development, deployment, and maintenance.
            </p>
          </div>
        </div>
      </div>
